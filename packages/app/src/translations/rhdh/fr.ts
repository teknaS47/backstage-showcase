...
const rhdhTranslationFr = createTranslationMessages({
  ...
  messages: {
    ...
    'menuItem.selfService': 'En libre service',
    ...
    'menuItem.rbac': 'RBAC',
    'menuItem.bulkImport': 'Importation en vrac',
    'menuItem.docs': 'Docs',
    'menuItem.lighthouse': 'Phare',
    'menuItem.techRadar': 'Radar technologique',
    'menuItem.orchestrator': 'Orchestrateur',
    'menuItem.adoptionInsights': "Perspectives sur l'adoption",
    'sidebar.menu': 'Menu',
    'sidebar.home': 'Accueil',
    'sidebar.homeLogo': "Logo d'accueil",
    'signIn.page.title': 'Choisissez une méthode de connexion',
    ...
    'signIn.providers.bitbucketServer.message':
      'Se connecter via le serveur Bitbucket',
    'signIn.providers.github.title': 'GitHub',
    'signIn.providers.github.message': 'Se connecter via GitHub',
    ...
    'signIn.providers.oidc.message': "Connectez-vous à l'aide d'OIDC",
    'signIn.providers.okta.title': 'Okta',
    'signIn.providers.okta.message': 'Connectez-vous via Okta',
    ...
    'signIn.providers.saml.message': 'Se connecter via SAML',
    ...
    'catalog.entityPage.pullRequests.title': 'Demandes de fusion/extraction',
    ...
    'catalog.entityPage.lighthouse.title': 'Phare',
    ...
    'app.userSettings.infoCard.copyMetadata':
      'Copiez les métadonnées dans votre presse-papiers',
    'app.userSettings.infoCard.showLess': 'Montrer moins',
    'app.userSettings.infoCard.showMore': 'Afficher davantage',
    'app.errors.contactSupport': "Contactez l'assistance",
...
export default rhdhTranslationFr;
