...
const rhdhTranslationDe = createTranslationMessages({
  ...
  messages: {
    ...
    'catalog.entityPage.imageRegistry.title': 'Bildregistrierung',
    'catalog.entityPage.monitoring.title': 'Überwachung',
    'catalog.entityPage.lighthouse.title': 'Leuchtturm',
    ...
    'app.errors.contactSupport': 'Kontaktieren Sie den Support.',
